        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-700">
              <th className="text-left text-gray-400 py-3 px-4 text-sm">Access</th>
              <th className="text-left text-gray-400 py-3 px-4 text-sm">Third Party</th>
              <th className="text-left text-gray-400 py-3 px-4 text-sm">Date</th>
              <th className="text-left text-gray-400 py-3 px-4 text-sm">Transaction</th>
            </tr>
          </thead>
          <tbody>
            {events.length === 0 ? (
